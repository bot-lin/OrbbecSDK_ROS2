...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('point_cloud_in_base_footprint', default_value='true'),
        DeclareLaunchArgument('base_footprint_frame_id', default_value='base_footprint'),
        DeclareLaunchArgument('enable_point_cloud_roi', default_value='false'),
        DeclareLaunchArgument('point_cloud_roi_min_x', default_value='-1000000.0'),
        DeclareLaunchArgument('point_cloud_roi_max_x', default_value='1000000.0'),
        DeclareLaunchArgument('point_cloud_roi_min_y', default_value='-1000000.0'),
        DeclareLaunchArgument('point_cloud_roi_max_y', default_value='1000000.0'),
        DeclareLaunchArgument('point_cloud_roi_min_z', default_value='-1000000.0'),
        DeclareLaunchArgument('point_cloud_roi_max_z', default_value='1000000.0'),
